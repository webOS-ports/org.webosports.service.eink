...
greyscale, clearer with less ghosting), `auto` (2, and 4 while active -
stock's "Hybrid" resting on the clearer waveform), `text` (3, nearly two-level), `ultra` (4, fastest). The
